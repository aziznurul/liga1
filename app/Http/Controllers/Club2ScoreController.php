...
use App\Http\Requests\Club2ScoreRequest;
use App\Models\Club;
use App\Models\ClubScore;
use Illuminate\Http\Request;

class Club2ScoreController extends Controller
{
    ...
    public function create() {
        ...
        $clubs = Club::all();
        return view('scores.create2', compact('clubs'));

    }
    public function store(Club2ScoreRequest $request) {
